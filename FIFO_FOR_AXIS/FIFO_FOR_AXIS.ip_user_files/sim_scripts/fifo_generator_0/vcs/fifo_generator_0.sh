...
#
# Generated by Vivado on Wed Oct 09 18:19:27 PDT 2019
...
# Script info
echo -e "fifo_generator_0.sh - Script generated by export_simulation (Vivado v2018.3_AR71948 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k \
    "$ref_dir/../../../../FIFO_FOR_AXIS.srcs/sources_1/ip/fifo_generator_0/sim/fifo_generator_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/media/wei/DATA/LW/Project/Vivado_Project/IP_Cores_PanoSETI/FIFO_FOR_AXIS/FIFO_FOR_AXIS.cache/compile_simlib/vcs"
  fi
